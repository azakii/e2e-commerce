...
const ProductItem = (item) => {
    ...
    return (
        <div onClick={() => addToCart(item.image, item.title, item.price)} className="item border p-2 mb-4 rounded-1">
            ...
            <div className="mt-4">
                ...
                <button className='btn btn-primary w-100 rounded-2'>add to cart</button> 
            </div>
        </div>
    );
}
